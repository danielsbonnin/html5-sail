...
class MiniMapComponent extends CanvasComponent {
    draw(ctx, args={width: 100, height: 100, boatPos: {x: 0, y: 0}, mapWidth: 100, mapHeight: 100}) {
        ctx.clearRect(0, 0, args.height, args.width);
        ctx.lineWidth = 5;
        let adjustedWidth = args.width - 5;
        let adjustedHeight = args.height - 5;
        ...
        ctx.fillRect(x, offsetY + offsetY*y, 5, 5);
    }
}